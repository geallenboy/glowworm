...
const findConversationByParticipantIds = (participantIds: any[]) => {
  const conversation = conversations.find((_conversation) => {
    if (_conversation.participants.length < participantIds.length) {
      return false;
    }
    const _participantIds: any[] = [];
...
export default [
  ...
  },
  {
    ...
    response: (params: any) => {
      ...
      return resultSuccess({ participants });
    }
  },
  {
    ...
    method: 'get',
    response: () => {
      return resultSuccess({ conversations });
    }
  },
  {
    ...
    response: (params: any) => {
      ...
      return resultSuccess({ conversation });
    }
  },
  {
  ...
  },
  {
    ...
    response: (params: any) => {
      ...
      return resultSuccess(responseData);
    }
  }
] as MockMethod[];
