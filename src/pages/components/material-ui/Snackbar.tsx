...
export default function SnackbarComponent() {
  ...
  const onSnackbarClose = (color: any) => {
    enqueueSnackbar(
      <div>
  ...
  const onSnackbarAction = (color: any, anchor?: any) => {
  ...
  return (
    <RootStyle title={`组件: Snackbar${title_main}`}>
      <Box
        sx={{
          pt: 6,
          pb: 1,
      ...
      >
        <Container maxWidth="lg">
          <HeaderBreadcrumbs
            ...
            moreLink={[
              'https://mui.com/zh/material-ui/react-snackbar/',
