import { Alert, AlertTitle, alpha, Box, Button, Container, Stack } from '@mui/material';
...
export default function AlertsComponent() {
  return (
    <RootStyle title={`组件：Alert${title_main}`}>
      <Box
        sx={{
          pt: 6,
          pb: 1,
      ...
      >
        <Container maxWidth="lg">
          <HeaderBreadcrumbs
            ...
            moreLink="https://mui.com/zh/material-ui/react-alert/"
          />
        </Container>
      </Box>
