import { Autocomplete, Box, Checkbox, Container, Grid, TextField, Typography } from '@mui/material';
...
export default function AutocompleteComponent() {
  ...
  return (
    <RootStyle title={`组件：Autocomplete${title_main}`}>
      <Box
        sx={{
          pt: 6,
          pb: 1,
      ...
      >
        <Container maxWidth="lg">
          <HeaderBreadcrumbs
            ...
            moreLink="https://mui.com/zh/material-ui/react-autocomplete/"
          />
        </Container>
      </Box>
